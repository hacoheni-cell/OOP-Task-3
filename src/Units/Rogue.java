...
public class Rogue extends Player {
    ...
    public Rogue(String name, int healthPool, int attack, int defence, Position pos, CombatSystem combat, char tileString, Integer cost, MessageCallback messageCallback) {
